...
# Chart 1: Average deaths over time
plt.figure(figsize=(8, 5))
df.groupby("Year")["Deaths"].mean().plot()
plt.title("Average Deaths Over Time")
plt.xlabel("Year")
plt.ylabel("Average Deaths")
plt.tight_layout()
plt.savefig("average_deaths_over_time.png")
plt.show()


# Chart 2: Average deaths by sex
plt.figure(figsize=(8, 5))
df.groupby("Sex")["Deaths"].mean().plot(kind="bar")
plt.title("Average Deaths by Sex")
plt.xlabel("Sex")
plt.ylabel("Average Deaths")
plt.tight_layout()
plt.savefig("average_deaths_by_sex.png")
plt.show()


# Chart 3: Linear regression trend
plt.figure(figsize=(8, 5))
plt.scatter(X_test1["Year"], y_test, label="Actual")
plt.plot(X_test1["Year"], linear_pred, label="Predicted")
plt.title("Linear Regression: Actual vs Predicted Deaths")
plt.xlabel("Year")
plt.ylabel("Deaths")
plt.legend()
plt.tight_layout()
plt.savefig("linear_regression_trend.png")
plt.show()
